...
> [!NOTE] 
> Jeśli sieć przewodowa podlega również ograniczeniom adresów MAC, adres MAC adaptera USB-C Hub + Ethernet również musi zostać wstępnie zatwierdzony. Należy zachować ostrożność przy użyciu tej karty, ponieważ umożliwi to dostęp do sieci z innych urządzeń.
...
Pozwoli to na zastosowanie poprawnego pakietu aprowizowania za pomocą pojedynczego dotknięcia urządzenia i zebranie adresu MAC urządzenia. [Pakiety aprowizowania można tworzyć zgodnie ze wskazówkami tutaj.](hololens-provisioning.md)
...
Pozwoli to na "odebranie" środowiska wdrażania dla technika, dzięki którym urządzenie będzie można od skrzynki do zarejestrowanej w usłudze Azure AD i Intune bez konieczności noszenia urządzenia przez technika lub ręcznej interakcji ze środowiskiem HoloLens operacyjnego.
