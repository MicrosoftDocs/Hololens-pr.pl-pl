...
|-------------------------|----------------------------|--------------|------------------|
| [Przenoszenie trybu platformy](#moving-platform-mode) | Wprowadzono tryb przenoszenia platformy w wersji beta, który po skonfigurowaniu umożliwia korzystanie z wersji HoloLens 2 w dużych serwerach z ruchami o niskiej dynamice. | Wszystko | 20348.1411 |
...
✔️ jeśli chcesz poznać ilość wolnego miejsca do magazynowania, dane SSID lub BSSID urządzeń HoloLens, zapoznaj się z tymi adresami [CSP raportowania.](#csp-changes-for-reporting-hololens-details) <br>
...
Teraz dodane w Windows niejawnych testerów istnieją dwie formy opinii na temat diagnostyki w trybie offline. Pierwsze z nich to wyskakujące powiadomienia wyświetlane zarówno podczas uruchamiania, jak i zakończenia zbierania. Będą one wyświetlane, gdy użytkownik jest zalogowany i ma wizualizacje.
...
W scenariuszach, w których wydaje się, że ilość miejsca na dysku na urządzeniu jest mała podczas zbierania dzienników diagnostycznych, zostanie **utworzony** dodatkowy raportStorageDiagnostics.zipo nazwie . Próg niskiego poziomu magazynu jest określany automatycznie przez Windows [magazynu](https://support.microsoft.com/office/use-onedrive-and-storage-sense-in-windows-10-to-manage-disk-space-de5faa9a-6108-4be1-87a6-d90688d08a48).
...
DeviceStatus CSP now also reports SSID and BSSID of Wi-Fi network which HoloLens is actively connected. Poniżej przedstawiono określone węzły zawierające te informacje.
...
Na urządzeniu HoloLens 2 przejdź do Ustawienia  >  **Update & Security**  >  **Windows niejawny program testów** wybierz pozycję **Wprowadzenie.** Połącz konto użyte do zarejestrowania się jako Windows insider.
...
Aby uzyskać więcej informacji, zobacz Introducing Windows Insider Channels on Windows Blogs (Wprowadzenie [do kanałów niejawnych](https://blogs.windows.com/windowsexperience/2020/06/15/introducing-windows-insider-channels) testerów) Windows Blogi.
...
Wybierz **pozycję > uruchom ponownie teraz,** aby zakończyć. Po ponownym uruchomieniu urządzenia przejdź do tematu **Ustawienia > Update & Security > Check for updates** to get the latest build (Sprawdzanie aktualizacji w celu uzyskania najnowszej kompilacji).
