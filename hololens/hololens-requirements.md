...
* Dołączanie do usługi Azure AD z Zarządzanie urządzeniami (MDM) — zarządzanie urządzeniami przenośnymi (MDM)
...
W odpowiednim przewodniku po chmurze opisano sposób rejestrowania usługi HoloLens 2 w usłudze zarządzania urządzeniami, stosowania licencji zgodnie z potrzebami i sprawdzania, czy użytkownicy końcowi mogą natychmiast używać usługi Remote Assist podczas konfigurowania urządzenia.
...
Odpowiedni bezpieczny przewodnik w trybie offline zawiera instrukcje stosowania przykładowego pakietu aprowizowania, który zablokuje HoloLens 2 do użycia w bezpiecznych środowiskach.
