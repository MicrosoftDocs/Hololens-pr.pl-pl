...
1. Na HoloLens użytkownik może następnie skonfigurować numer **PIN** przy użyciu Ustawienia opcji logowania Dodaj  >    >   numer PIN.
...
- **Azure AD:** prosi o uwierzytelnianie domyślnie i można je skonfigurować Ustawienia **nie** pyta o uwierzytelnianie.
