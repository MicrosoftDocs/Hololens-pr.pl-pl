...
**(Należy pamiętać, że jeśli sieć nie ma szybkości sieci co najmniej 1,5 Mb/s, funkcja Remote Assist nadal będzie działać. Jednak jakość może ulec chybowi).**
...
Aby [uzyskać HoloLens, zobacz Wymagania](hololens-licenses-requirements.md) licencyjne.
...
1. Ten krok należy wykonać tylko wtedy, gdy użytkownicy mają zarejestrować swoje urządzenie HoloLens/urządzenia przenośne (dostępne są trzy opcje) Te kroki zapewniają, że użytkownicy w firmie (lub grupa użytkowników) mogą dodawać urządzenia.
 ...
 **Ustaw dla ustawienia Użytkownicy mogą dołączać urządzenia do usługi Azure AD wartość *Wszystkie***
    ...
    1. **Opcja 2:** Nadaj wybranym użytkownikom/grupom uprawnienia do dołączania urządzeń do usługi Azure AD Zaloguj się do usługi **Azure Portal** jako administrator urządzenia urządzenia Azure Active Directory Urządzenia Ustawienia Ustaw opcję Użytkownicy mogą dołączać urządzenia do usługi Azure AD na wybrany obraz, który pokazuje konfigurację urządzeń przyłączony do usługi  >    >    >    >
 **** 
