...
Jeśli twoja infrastruktura już obsługuje profil [](/mem/intune/protect/certificates-profile-scep) SCEP, musisz utworzyć profil dla każdego certyfikatu SCEP, który będzie HoloLens 2. [](/mem/configmgr/protect/deploy-use/create-certificate-profiles) Jeśli masz problemy z profilem SCEP, użyj narzędzia Rozwiązywanie problemów z użyciem profilów certyfikatów [SCEP,](/troubleshoot/mem/intune/troubleshoot-scep-certificate-profiles)aby aprowizować certyfikaty za pomocą Microsoft Intune .
