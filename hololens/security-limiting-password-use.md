...
Aby zapewnić dodatkowe zabezpieczenia, poświadczenia usługi Windows Hello są chronione przez moduł Trusted Platform Module (TPM), aby zapewnić odporność na naruszenia poświadczeń i uzupełnione o zabezpieczenia przed wieloma nieprawidłowymi wpisami oraz ochronę przed złośliwym oprogramowaniem, aby zapobiec narażeniu na nie. Aby uzyskać więcej informacji na temat Sign-On (SSO), przeczytaj to [omówienie metod logowania jednokrotnego.](/azure/active-directory/manage-apps/what-is-single-sign-on)
