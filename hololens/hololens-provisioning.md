...
> [!NOTE]
> Jeśli wiesz, że będziesz używać komputera w trybie offline, który wymaga dostępu do programu Windows Configuration Designer, postępuj zgodnie z instrukcjami [instalacja aplikacji w trybie offline(hololens-recovery.md#downloading-arc-without-using-the-app-store) dotyczącymi zaawansowanej pomocnika odzyskiwania. Zaznacz Windows Configuration Designer. 
...
| **Zasady** | Zezwala na tryb dewelopera na HoloLens. [Zasady obsługiwane przez Windows Holographic for Business](/windows/client-management/mdm/policy-configuration-service-provider#hololenspolicies) |
