...
1. Sprawdź, czy HoloLens są wyświetlane na liście i czy ich stan profilu to **Przypisane.**  
...
1. Środowisko rozwiązania Autopilot wymaga dostępu do Internetu. Aby zapewnić dostęp do Internetu, użyj jednej z następujących opcji:
    ...
    - Połączenie z siecią Ethernet przy użyciu adapterów "USB-C–Ethernet" do łączności przewodowej z Internetem i automatycznie HoloLens 2 kompletne środowisko rozwiązania Autopilot.

    - Połączenie urządzenia z adapterami "USB-C do Wi-Wi-Wi", które umożliwiają bezprzewodowe połączenie z Internetem, HoloLens automatycznie ukończyć środowisko rozwiązania Autopilot.
...
HoloLens 2 obsługują usługę TenantLockdown CSP od Windows Holographic w wersji 20H2. Ten program CSP utrzymuje urządzenia w dzierżawie organizacji, blokując je do tej dzierżawy nawet przez zresetowanie urządzenia lub reflash.
