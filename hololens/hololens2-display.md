...
* **[Wybiegaj wzrok.](hololens-calibration.md#calibrating-your-hololens-2)** Ekran używa odległości międzypołudowej (IPD) i spojrzenia okiem, aby zoptymalizować obrazy na ekranie. Jeśli nie uruchamiasz kontroli wzroku, jakość obrazu może się pogorszyć. Aby uruchomić oczu, przejdź do **Ustawienia**  >    >  **systemowego.**  >  
...
* **Czas naświetlania aparatu.** Czas narażenia aparatu musi być dokładną wielokrotnością 1/120 sekundy. Szybkość HoloLens ekranu wynosi 120 Hz. Ze względu na sposób, w jaki HoloLens 2 rysuje obrazy, przechwytywanie pojedynczej ramki również nie wystarczy, aby dopasować je do wizualnego doświadczenia człowieka. W tym samym czasie, jeśli urządzenie w ogóle się przesuwa — nawet mikroukładzie — system reprojects obrazu na ekranie, aby ustabilizować hologramy. Przechwytywanie wielu ramek przy zachowaniu HoloLens przed przenoszeniem zwykle wymaga konfiguracji laboratoryjnej.
...
Użytkownicy będą mieli najlepsze środowisko w przypadku unikania białych tła. Tryb ciemny to zasada projektowania używana przez aplikacje do używania czarnego lub ciemnego tła. Ustawienia systemu są domyślnie ustawiane na tryb ciemny i można je dostosować, przechodząc **do Ustawienia**  >    >  **systemowego**.

Deweloperom zaleca się, aby postępowali zgodnie ze wskazówkami projektowania w trybie ciemnym:

* [Developer design guidelines for HoloLens displays (Wytyczne dotyczące projektowania HoloLens dewelopera)](/windows/mixed-reality/designing-content-for-holographic-display#design-guidelines)
...
Użyj mikrofibry, aby wyczyścić osłonę. Aby odczyszczyć osłodę, użyj 70% izopropylu do lekkiego nawilżenia daszka, a następnie wyczyszcz go. Przeczytaj pełne wskazówki w często [zadawanych pytaniach dotyczących czyszczenia HoloLens 2.](hololens2-maintenance.md)
