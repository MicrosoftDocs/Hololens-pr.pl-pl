...
> [!NOTE]  
> **Użytkownicy komercyjni lub przedsiębiorstwa:** Jeśli używasz aplikacji Centrum opinii do zgłaszania problemu związanego z zarządzaniem urządzeniami przenośnymi, aprowizowaniem lub innym aspektem zarządzania urządzeniami, zmień kategorię aplikacji na **Enterprise Management**  >  **Device**.
...
Zobacz więcej:
- [Zbieranie danych diagnostycznych z urządzenia Windows danych](/mem/intune/remote-actions/collect-diagnostics)
...
Zachowanie przed [Windows Holographic w wersji 20H2:](hololens-release-notes.md#windows-holographic-version-20h2)
...
- Aby wyłączyć diagnostykę w trybie offline, przejdź **do Ustawienia Zasady > aplikacji** i wybierz pozycję Podstawowe **w** danych **diagnostycznych.** W przypadku kompilacji, w których diagnostyka offline zależy od ustawienia telemetrii, ma ona wpływ tylko na to, czy są zbierane jakiekolwiek dzienniki. Nie ma to wpływu na to, jakie pliki są zbierane.
