...
> [!NOTE]  
> W tej ścieżce pliku i nazwie reprezentuje nazwę urządzenia HoloLens oraz datę i godzina utworzenia \<*HoloLens device name*> \<*ddmmyyhhmmss*> pliku.
...
Aby wyświetlić diagnostykę MDM na komputerze HoloLens 2, wybierz ikonę sieci Wi-Fi, a następnie przejdź do opcji Konta usługi **Ustawienia** Uzyskaj dostęp do konta służbowego i wybierz pozycję Eksportuj  ->    >   **dzienniki zarządzania.** HoloLens wysyła pliki dziennika na Twoje konto i wyświetla ich lokalizację na komputerze stacjonarnym.
