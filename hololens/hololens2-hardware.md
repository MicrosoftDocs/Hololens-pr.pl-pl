...
---
# <a name="about-hololens-2"></a>Informacje o urządzeniach HoloLens 2

![Widok boczny urządzenia HoloLens 2](images/hololens2-breakdown.png)

Microsoft HoloLens 2 jest nieukońcowany komputer holograficzny.  Uściślił on podróż po obliczeniach holograficznych rozpoczętą przez urządzenie HoloLens (1. generacja), aby zapewnić wygodniejsze i immersyjne środowisko połączone z większej liczby opcji współpracy w rzeczywistości mieszanej. Do korzystania z urządzenia HoloLens 2 wymagane jest konto użytkownika.

## <a name="hololens-components"></a>Składniki urządzenia HoloLens

- **Visor .** Zawiera czujniki i ekrany urządzenia HoloLens. Możesz obrócić wizjer w górę podczas noszenia urządzenia HoloLens.
- **Pałąk headband**. Aby umieścić urządzenie HoloLens, rozwiń pałąk za pomocą kółka korekty. Gdy urządzenie HoloLens jest na miejscu, zawężaj koło korekty, obracając się w prawo, aż pasek będzie wygodny.
- **Przyciski jasność**. W przypadku noszenia urządzenia HoloLens przyciski jasność znajdują się po lewej stronie oszołomyka w pobliżu twojej orzesza.
- **Przyciski regulacji głośności**. W przypadku noszenia urządzenia HoloLens przyciski regulacji głośności znajdują się po prawej stronie przyszyciem w pobliżu twojej orzesza.
- **Przycisk zasilania**. Podczas noszenia urządzenia HoloLens przycisk zasilania znajduje się po prawej stronie tylnej zewnętrznej okładki.
- **Port USB-C.** Podczas noszenia urządzenia HoloLens port USB-C znajduje się po prawej stronie zewnętrznej okładki pod przyciskiem Zasilania.
...
- **[Narzut](https://www.microsoft.com/p/microsoft-hololens-2-overhead-strap/8wxl8wmk1f7z)**. Podczas poruszania się po urządzeniu HoloLens użyj narzutu, aby zachować urządzenie na miejscu. Podczas noszenia urządzenia HoloLens przez dłuższy czas obciążenie może sprawić, że urządzenie będzie bardziej wygodne w zużyciu.
- **[Usb-C i kabel](https://www.microsoft.com/p/microsoft-hololens-2-usb-c-charger-cable/8vj21f2z8pk5)**. Zasilacz podłącza się do gniazda zasilania. Użyj kabla USB-C, aby podłączyć urządzenie HoloLens do zasilacza w celu ich ładowania lub podłączyć urządzenie HoloLens do komputera.
- **Mikrofibry.** Użyj , aby wyczyścić swoją wizjer urządzenia HoloLens.

### <a name="power-supply-details"></a>Szczegóły zasilacza

Zasilacz i kabel USB, które są wyposażone w urządzenie, są najlepszym obsługiwanym mechanizmem ładowania. Zasilacz to zasilacz o mocy 18 W.  Dostarcza 9V przy 2A.
...
### <a name="compute-and-connectivity"></a>Obliczenia i łączność

|   |   |
| - | - |
| System na mikroukładzie | Szczegółowe informacje o platformie [](https://www.qualcomm.com/products/snapdragon-850-mobile-compute-platform) obliczeniowej 850 |
...
### <a name="human-understanding"></a>Punkt widzenia człowieka
...
| Połączenia głosowe | Sterowanie i sterowanie na urządzeniu; Język naturalny Cortany z łącznością z Internetem |
...
## <a name="pre-installed-software"></a>Wstępnie zainstalowane oprogramowanie

|   |   |
| - | - |
| System operacyjny Windows Holographic | W systemie Windows Holographic Windows 10 użytkownicy będą mogli korzystać z niektórych swoich aplikacji i gier w środowisku rzeczywistości mieszanej za pośrednictwem urządzenia HoloLens 2.
...
| Cortana | [Cortana](https://www.microsoft.com/p/cortana/9nffx4szz23l?activetab=pivot:overviewtab)— osobisty asystent produktywności — pomaga być na kwestiach ważnych i oszczędzać czas na znajdowaniu potrzebnych informacji.  |
| Dynamics 365 Guides |  [Przewodniki usługi Dynamics 365](https://www.microsoft.com/p/microsoft-dynamics-365-guides/9n038fb42kkb?activetab=pivot:overviewtab) pomogą pracownikom szybciej nauczyć się nowych umiejętności na urządzeniach HoloLens. |
...
| Centrum opinii | [Centrum opinii](https://www.microsoft.com/p/feedback-hub/9nblggh4r32n?activetab=pivot:overviewtab) udostępniając sugestie lub problemy, możesz przekazać opinię na temat systemu Windows i aplikacji.  |
...
| Sklepie Microsoft | Aplikacja [Microsoft Store](https://www.microsoft.com) to źródło aplikacji i gier, które działają z urządzeniem HoloLens.|
| Filmy & TV | [Filmy & TV](https://www.microsoft.com/p/movies-tv/9wzdncrfj3p2?activetab=pivot:overviewtab) to najnowsza animacja w jednej prostej, szybkiej i eleganckim aplikacji. |
| OneDrive | [Aplikacja OneDrive](https://www.microsoft.com/p/onedrive/9wzdncrfj1p3?activetab=pivot:overviewtab) umożliwia dostęp do plików i edytowanie ich ze wszystkich urządzeń w dowolnym miejscu.  |
...
| Ustawienia | Aplikacja Ustawienia to miejsce, w którym można szczegółowo dostosować sposób działania systemu Windows Holographic.  |
| Porady | [Porady](https://www.microsoft.com/p/microsoft-tips/9wzdncrdtbjj?activetab=pivot:overviewtab) pozwalają opanowywać zaskakujące i mniej znane rzeczy, które można robić na urządzeniach z systemem Windows Holographic. |
...
* Bezpieczeństwo oczu: urządzenie HoloLens 2 zostało przetestowane i jest zgodne z podstawowymi wymaganiami w zakresie ochrony przed wpływem ansi Z87.1, CSA Z94.3 i EN 166.
...
[HoloLens Regulatory](https://support.microsoft.com/en-us/help/13761/hololens-regulatory-information): zawiera informacje dotyczące temperatury, usuwania, interferencji radiowej i tv i nie tylko.
...
Kupując urządzenie HoloLens 2, akceptujesz umowę licencyjną [na oprogramowanie](https://www.microsoft.com/Useterms/).

Nie jest przeznaczony do użytku przez dzieci w wieku poniżej 13 lat.

## <a name="package-dimensions"></a>Wymiary pakietu

|      Miara               |      Metryka jednostek     |      Jednostki     |
|--------------------------------|-----------------------|-------------------------|
...
> [!NOTE]
> - Jednostka: w urządzeniu HoloLens 2 jest sprzedawane czarne opakowanie w stylu sklepu detalicznego.
...
1. Kliknij prawym przyciskiem myszy i **wybierz pozycję** Właściwości urządzenia HoloLens
...
> [Konfigurowanie i uruchamianie urządzenia HoloLens 2](hololens2-setup.md)
